...
u6 = User.create(username: 'Midnight', email: 'thejndave@gmail.com', password: 'password', avatar_url: seedUrl + "lazers.jpg")
u7 = User.create(username: 'Stank Williams', email: 'aq@gmail.com', password: 'password', avatar_url: "mountains.jpg")
...
u1.demos.create({title: "Question of Honor", thumb_url: u1.avatar_url, audio_url: seedUrl + "sj1.mp3"});
u1.demos.create({title: "Your Move Creep", thumb_url: u1.avatar_url, audio_url: seedUrl + "sj2.mp3"});
...
u2.demos.create({title: "I Never Will Marry (lol both married)", thumb_url: u2.avatar_url, audio_url: seedUrl + "hb3.mp3"});
u2.demos.create({title: "Tear My Stillhouse Down", thumb_url: u2.avatar_url, audio_url: seedUrl + "hb4.mp3"});
u2.demos.create({title: "Words to sing", thumb_url: u2.avatar_url, audio_url: seedUrl + "hb5.mp3"});
...
u5.demos.create({title: "He Rides At Night", thumb_url: u5.avatar_url, audio_url: seedUrl + "superdeath2.mp3"});
u6.demos.create({title: "Guess What Time It I'm Thinking About", thumb_url: u6.avatar_url, audio_url: seedUrl + "superdeath3.mp3"});
...
u8.demos.create({title: "I live in Brighton bla bla bla", thumb_url: u6.avatar_url, audio_url: seedUrl + "murdersquad3.mp3"});

u10.demos.create({title: "Demo 1", thumb_url: u10.avatar_url, audio_url: seedUrl + "tfb1.mp3"});
u10.demos.create({title: "Demo 2", thumb_url: u10.avatar_url, audio_url: seedUrl + "tfb1.mp3"});
u10.demos.create({title: "Demo 3", thumb_url: u10.avatar_url, audio_url: seedUrl + "tfb1.mp3"});
